    ...
    <footer className="border-t border-charcoal/10 bg-[#f1ebe1] px-6 py-14 md:px-10">
      <div className="mx-auto grid max-w-6xl gap-10 text-sm text-espresso/85 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/contact" className="transition hover:text-charcoal">Begin a private conversation</Link></li>
            <li><span className="text-espresso/75">Private showings by appointment</span></li>
          </ul>
        </div>
